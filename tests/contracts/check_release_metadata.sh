...
grep -Fq "soversion: '2'" "$root/src/meson.build"
grep -Fq "libpkgapply >= 3.0.0" "$root/src/meson.build"
grep -Fq "abi/libpkgapply-exec.exports" "$root/tests/contracts/check_abi_contract.sh"
