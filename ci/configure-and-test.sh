...
for variable in \
  LIBPKGSOURCE_SOURCE LIBPKGSTATE_SOURCE LIBPKGIMAGE_SOURCE \
  LIBPKGCATALOG_SOURCE LIBPKGRESOLVE_SOURCE LIBPKGBUILD_SOURCE \
  LIBPKGPLAN_SOURCE LIBPKGBUILD_IMAGE_SOURCE LIBPKGSOURCE_PLAN_SOURCE \
  LIBPKGBUILD_PLAN_SOURCE LIBPKGAPPLY_SOURCE LIBPKGEXEC_SOURCE
do
  eval "value=\${$variable:-}"
...
setup_dependency "$LIBPKGEXEC_SOURCE" "$build/libpkgexec"
